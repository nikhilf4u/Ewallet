 ...
 $db="ewallet";
  ...
  if(isset($_POST['email']))
  {
		...
		{ 
          ...
          $mail->Body="click on the link to verify http://localhost/ewallet-master/activate.php?vkey=$vkey";
          if(!$mail->send())
         	$_SESSION['mailerror']="email not sent";
          else
        	$_SESSION['mailsuccess']="thankyou for registering please verify you mail";
